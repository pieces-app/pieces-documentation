...
You can choose between [different LLMs directly within the Pieces Web Extension](https://docs.pieces.app/products/web-extension/copilot/llm-settings) by accessing the sidebar and clicking on your preferred model under `Active Model` (e.g., _Claude 3.5 Sonnet_).
