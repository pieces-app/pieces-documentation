...
Get started by selecting your favorite IDE, editor, or productivity tool.
...
<CardGroup cols={2}>
  ...
  <Card title="JupyterLab Extension">
    <div
      style={{
        display: 'flex',
        alignItems: 'center',
    ...
    >
      <img
        ...
        alt="JupyterLab icon"
      />
      {/* omit the span if you just want the arrow */}
      <Icon icon="arrow-up-right" size={30} />
    </div>
  </Card>
</CardGroup>
