...
description: "Browse documentation for the Pieces Desktop App, Core Dependencies, all Pieces plugins and extensions for your favorite IDEs and productivity tools, read quick guides on setting up Model Context Protocol (MCP) servers, and much more."
---
...
Get started with the Pieces Desktop App or learn more about PiecesOS and Ollama, the two \_core dependencies \_required to unlock full Long-Term Memory Engine (LTM-2.5) and local LLM functionality.
