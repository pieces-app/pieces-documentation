...
description: "The Model Context Protocol (MCP) settings let you configure and manage MCP integration with PiecesOS, enabling connectivity between Large Language Models (LLMs) and your personal context stored by the Long-Term Memory Engine (LTM-2)."
---
