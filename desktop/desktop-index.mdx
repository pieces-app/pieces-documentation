...
sidebarTitle: "About the Desktop App"
---
...
<CardGroup cols={2}>
  <Card title="Getting Started" horizontal img="/public/icons/pieces_filled.svg">
  ...
  <Card title="Support" img="/public/icons/pieces_dark_outline.webp">
    Explore troubleshooting options, visit our [support page](https://docs.pieces.app/products/support), or book a call directly with our engineers.
  </Card>
</CardGroup>
...
[The Long-Term Memory (LTM-2) engine](https://docs.pieces.app/products/core-dependencies/pieces-os#ltm-2) ensures that _nothing_ slips through the cracks.
