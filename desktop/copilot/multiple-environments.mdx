...
The Copilot experience supports _cross-threading._
...
In platforms such as JetBrains, Visual Studio Code, and the Pieces Web Extension, Pieces leverages a dedicated Flutter-based _Applet_ view which provides a standardized user experience for interacting with Pieces Copilot and the Pieces Drive.

---

_Pieces Web Extension_
...
_Pieces for Sublime Text Plugin_
