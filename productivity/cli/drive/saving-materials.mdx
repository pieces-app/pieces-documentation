...
This helps you save time when writing generic code in various forms. The Pieces CLI offers a _create_ feature designed to assist you with this.
...
- `Custom Description`: Specifies exactly which _lines_ (by number) the snippet is from and the file it came from—handy for mind-mapping.
