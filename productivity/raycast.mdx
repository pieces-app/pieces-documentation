...
With just a few keystrokes, you can capture, search, and manage code snippets from anywhere on your desktop—_without switching context._
...
3. Search for _"Pieces for Raycast"_
4. Click `Install`
