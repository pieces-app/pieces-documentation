...
<Card title="Want a Sneak Peak?">
  Here's a <a target="_blank" href="https://tsavo.hashnode.dev/temporal-nano-model-breakthrough">detailed explanation</a> of how LTM-2 works.
