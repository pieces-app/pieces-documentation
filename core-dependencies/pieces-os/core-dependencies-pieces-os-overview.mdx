---
sidebarTitle: "What is PiecesOS?"
title: "Learn about PiecesOS"
description: "Discover what powers the Pieces for Developers experience under the hood."
---
...
![Pieces Copilot with LTM-2 Context — Pieces Desktop App](https://cdn.hashnode.com/res/hashnode/image/upload/v1734028488469/d128a760-7e91-4dbf-8cfc-e7fc257488b7.png?auto=compress,format&format=webp&q=75?auto=compress,format&format=webp&q=75)
...
![Pieces MCP —\> Cursor](https://storage.googleapis.com/hashnode_product_documentation_assets/core_dependencies_assets/pieces_os_main/cursor_change_documentation_from_conversation_2_agentic_demo_screenshot.png)
