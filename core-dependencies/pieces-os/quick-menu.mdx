...
![PiecesOS Quick Menu on macOS](https://storage.googleapis.com/hashnode_product_documentation_assets/core_dependencies_assets/pieces_os_main/quick_menu/macos_quickmenu_new.png)
...
3. **Most Recent Websites:** Shows the last visited web pages that PiecesOS captured. Each website is listed with a clickable URL
...
<Tabs>
  ...
  <Tab title="Follow Us">
    - [Discord](https://discord.com/invite/ubn8JFAXQ7)
    - [X](https://x.com/getpieces)
    - [LinkedIn](https://www.linkedin.com/company/getpieces)
    - [GitHub](http://github.com/pieces-app)
...
- **Discoverer Integrations:** Opens the Pieces website, where you can find all [Pieces for Developers browser and IDE extensions and plugins](https://pieces.app/plugins).
...
- **Submit Feedback or Issues:** If you're experiencing an issue, click this button to open a webpage with a form for submitting bug reports or providing feedback. [You can also visit our Support page here to do so.](https://docs.pieces.app/products/support)
