...
Ollama is an _optional_ dependency that enables local AI inference for Pieces Copilot and other AI-powered features in Pieces for Developers.
...
Visit the <a target="_blank" href="https://ollama.com/download">
official Ollama website</a>

 to download the latest version, then install using the platform-specific instructions below.
...
<Tabs>
  <Tab title="macOS">
    **Ollama | macOS Installation**
    ...
    1. Download the **macOS installer (**`.pkg`**)** from the <a target="_blank" href="https://ollama.com/download">
       Ollama website.</a>
  ...
  <Tab title="Windows">
    **Ollama | Windows Installation**
    ...
    1. Download the **Windows installer (.exe)** from the <a target="_blank" href="https://ollama.com/download">
       Ollama website.</a>
