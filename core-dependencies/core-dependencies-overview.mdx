---
sidebarTitle: "Understanding Core Dependencies"
title: "Core Dependencies of Pieces"
description: "Learn what technologies are used by Pieces to run the Long-Term Memory Engine (LTM-2.5) and support locally-hosted Large Language Models (LLMs). "
---
