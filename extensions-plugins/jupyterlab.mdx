...
Make sure extensions are enabled. If you don’t know how to do this, <a target="_blank" href="https://tljh.jupyter.org/en/latest/howto/admin/enable-extensions.html">
see the Jupyter documentation</a>
...
![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/JUPYTER/MACOS/EXPANDED_VIEW/16X9/PIECES_FOR_DEVELOPERS-JUPYTER-EXPANDED_VIEW-16X9-MACOS-6_22_2023.gif)
