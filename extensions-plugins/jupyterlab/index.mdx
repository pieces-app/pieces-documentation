...
<tip>
  Pieces For Developers captures _no identifiable user data._ Our local-only architecture means your data never has to leave your device.
</tip>
...
click here for official Jupyter documentation</a>
