...
In addition, there is also `Pieces: Comment`, which you can read more about <a target="_blank" href="https://docs.pieces.app/products/extensions-plugins/jetbrains/copilot/documenting-code#via-pieces-comment">
here</a>
