...
- `Custom Description`: Specifies precisely which _lines_ (in numerical form) the snippet is from and the file from which it originated—very useful for mind-mapping.
