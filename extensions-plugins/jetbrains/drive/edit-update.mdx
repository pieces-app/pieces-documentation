...
_Layers upon layers of functionality_—that's the aim of all Pieces for Developers plugins and extensions.
...
Instead, the `Edit` view _becomes_ your main file, so you can [generate code comments, debug, add it to context, and more.](https://docs.pieces.app/products/extensions-plugins/jetbrains/copilot)