...
<Tip>
  When using these prompts, ensure you have LTM-2 turned on, both the [LTM](https://docs.pieces.app/products/core-dependencies/pieces-os/quick-menu#ltm-2-engine), and the [LTM context source](https://docs.pieces.app/products/desktop/copilot/integration#ltm-context-toggle) in the copilot chat.
</Tip>
