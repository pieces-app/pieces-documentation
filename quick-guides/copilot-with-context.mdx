...
<Steps>
  <Step title="Review the GitHub Issue">
    ...
    \
    You can [use this issue](https://github.com/pieces-app/pieces-certification-course-content/issues/1) as an example.
  </Step>
...
![](https://storage.googleapis.com/hashnode_product_documentation_assets/quick_guides/using_pieces_copilot_with_memory_context/summarize_this_issue_demo.png)
...
<Steps>
  <Step title="Clone the Project Repo">
    [Clone this GitHub repository.](https://github.com/pieces-app/pieces-certification-course-content)
  </Step>
...
<Steps>
  <Step title="via Pieces Desktop App">
    ...
    ![](https://storage.googleapis.com/hashnode_product_documentation_assets/quick_guides/using_pieces_copilot_with_memory_context/add_as_context_PFD.png)
  </Step>
  <Step title="via VS Code with Pieces Installed">
    ...
    ![](https://storage.googleapis.com/hashnode_product_documentation_assets/quick_guides/using_pieces_copilot_with_memory_context/add_as_context_VSC.png)
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Check the Response">
    ...
    ![](https://storage.googleapis.com/hashnode_product_documentation_assets/quick_guides/using_pieces_copilot_with_memory_context/implem_in_project.png)
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Check the Response">
    ...
    ![](https://storage.googleapis.com/hashnode_product_documentation_assets/quick_guides/using_pieces_copilot_with_memory_context/dual_prompt.png)
  </Step>
</Steps>