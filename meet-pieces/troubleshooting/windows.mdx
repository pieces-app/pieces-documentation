...
<CardGroup cols={2}>
  ...
  <Card title="Download — Pieces Desktop App" href="https://builds.pieces.app/stages/production/pieces_for_x/windows-exe/download?download=true&product=DOCUMENTATION_WEBSITE">
