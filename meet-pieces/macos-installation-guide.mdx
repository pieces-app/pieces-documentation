...
<CardGroup cols={2}>
  <Card title="Download — PiecesOS & Pieces Desktop App (ARM)" href="https://builds.pieces.app/stages/production/macos_packaging/pkg-arm64/download?download=true&product=DOCUMENTATION_WEBSITE" img="/public/icons/apple.svg">
    _macOS 13.0 (Ventura) or higher required_
  </Card>
  <Card title="Download — PiecesOS & Desktop App (Intel)" href="https://builds.pieces.app/stages/production/macos_packaging/pkg/download?download=true&product=DOCUMENTATION_WEBSITE" img="/public/icons/intel.webp">
    _macOS 13.0 (Ventura) or higher required_
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Download — PiecesOS (DMG / ARM)" href="https://builds.pieces.app/stages/production/os_server/dmg-arm64/download" img="/public/icons/macos.webp">
  ...
  <Card title="Download — Pieces Desktop App (DMG / ARM)" href="https://builds.pieces.app/stages/production/pieces_for_x/dmg-arm64/download" img="/public/icons/macos.webp">
...
<CardGroup cols={2}>
  <Card title="Download — PiecesOS (DMG / Intel)" href="https://builds.pieces.app/stages/production/os_server/dmg/download" img="/public/icons/macos.webp">
    **Step 1:** Download PiecesOS
  ...
  <Card title="Download — Pieces Desktop App (DMG / Intel)" href="https://builds.pieces.app/stages/production/pieces_for_x/dmg/download" img="/public/icons/macos.webp">
    **Step 2:** Download the Desktop App
...
<Card title="Installing via Homebrew" img="/public/icons/homebrew.png">
